...
// values when site/kernels.json exists, else 2 / 512.
...
try { defaults = JSON.parse(fs.readFileSync(path.join(W, 'site', 'kernels.json'))).kernels.find(k => k.name === kernel) ?? defaults; } catch {}
